...
JIS X 0208 Level 1 Kanji), and exports standard .tbl and .json mapping tables.
"""
...
class PersonaFontTool:
    def __init__(self, font_path: str = "extracted/FONT.BIN"):
        ...
        self.raw_data = self.font_path.read_bytes()
    ...
    def _build_character_maps(self):
        """Construct full 2048 character map combining non-kanji and JIS Level 1 Kanji."""
    ...
    def get_glyph_data(self, glyph_id: int) -> bytes:
        ...
        if 0 <= glyph_id < self.glyph_count:
            return self.raw_data[glyph_id * BYTES_PER_GLYPH : (glyph_id + 1) * BYTES_PER_GLYPH]
